	...
	/******************** PRJ-BU2-JAVA-004 Task1 ********************/
	 public static void main(String[] args){
		...
		// System.out.println(star1);
		 ...
		 System.out.println("原泡泡糖对象为：" + "(" + star.getPosition().getRow() + "," +star.getPosition().getColumn() + "-" + star.getType() + ")");
		 System.out.println("克隆泡泡糖对象为：" + "(" + star1.getPosition().getRow() + "," +star1.getPosition().getColumn() + "-" + star1.getType() + ")");
		 System.out.println("两对象是否一致：" + star.equals(star1) );
		 System.out.println("两对象的坐标对象是否一致：" + star.equals(star1) );
	 }
