...
public class StarServiceImpl implements StarService {
	...
	private void testForSync(StarList stars){
		for(int i=0;i<stars.size();i++){
			stars.get(i).setType(Star.StarType.YELLOW);
		}
		stars.get(90).setType(StarType.PURPLE);
		stars.get(91).setType(StarType.PURPLE);
		stars.get(92).setType(StarType.PURPLE);
		stars.get(93).setType(StarType.PURPLE);
		stars.get(80).setType(StarType.PURPLE);
		stars.get(81).setType(StarType.RED);
		stars.get(82).setType(StarType.RED);
		stars.get(83).setType(StarType.valueOf((int)(Math.random() * StarService.STAR_TYPES)));
		stars.get(84).setType(StarType.valueOf((int)(Math.random() * StarService.STAR_TYPES)));
		stars.get(94).setType(StarType.valueOf((int)(Math.random() * StarService.STAR_TYPES)));
		stars.get(70).setType(StarType.valueOf((int)(Math.random() * StarService.STAR_TYPES)));
	}
	
	public void test001(StarList stars){
		for(int i=0;i<stars.size();i++){
			stars.get(i).setType(Star.StarType.YELLOW);
		}
	}
	
	public void test002(StarList stars){
		for(int i=0;i<stars.size();i++){
			stars.get(i).setType(Star.StarType.GREEN);
		}
		stars.get(90).setType(StarType.BLUE);
		stars.get(91).setType(StarType.YELLOW);
		stars.get(92).setType(StarType.BLUE);
		stars.get(93).setType(StarType.YELLOW);
		stars.get(94).setType(StarType.BLUE);
		stars.get(95).setType(StarType.YELLOW);
		stars.get(96).setType(StarType.BLUE);
		stars.get(97).setType(StarType.YELLOW);
		stars.get(98).setType(StarType.BLUE);
		stars.get(99).setType(StarType.YELLOW);
	}
